...
// ) => {
//   try {
//     // Define the template path for the admin notification
//     const templatePath = path.resolve(
//       __dirname,
//       "../views/registrationEmail.template.html"
//     );

//     // Template data to replace in the email
//     const templateData = {
//       userName: userName,
//       userEmail: userEmail,
//       userRole: userRole,
...
//     // Call sendEmail from the utils file
//     const emailSent = await sendEmail(
//       process.env.ADMIN_EMAIL, // Admin email address
//       "New Registration Pending Approval", // Email subject
//       templatePath, // Path to the template
//       templateData // Template data to replace placeholders
//     );
